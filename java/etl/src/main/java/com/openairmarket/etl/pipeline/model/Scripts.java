...
/**
 * Java class for scripts complex type.
 *
...
public class Scripts {
   ...
   * there is not a <CODE>set</CODE> method for the script property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Script }
   */
